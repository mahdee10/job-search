...
export default function Footer() {
    return (
        <div >
            <div className="sm:h-44 h-20 bg-fbfbfb 1"></div>
            
            <div className="relative">
            <div className="flex justify-center 2 absolute left-1/2 transform -translate-x-1/2 top-0 transform -translate-y-1/2 ">
                <div className="bg-003A2C sm:w-fw sm:h-fhh sm:rounded-3xl rounded flex justify-center flex-col items-center w-80 sm:p-0 p-5">

                    <h3 className="font-black text-white sm:text-3xl text-base sm:pt-14 w-full text-center ">Register your CV now</h3>
            ...
            <div className="3 bg-my-green flex justify-between sm:px-24 px-12 sm:pt-8 sm:pb-12 mx-auto 2xl:container pb-10 overflow-hidden sm:pt-20 pt-10 flex-wrap">
                <div className="flex items-center flex-col sm:pt-32 sm:w-80 w-full">
                    <h3 className="font-black text-white sm:text-3xl text-2xl pt-14 w-full "><span className="text-black">Job</span>Now</h3>
                    <p className="text-white sm:text-xs  text-xxxs sm:pt-5 pt-1 sm:pb-9 pb-2  sm:pr-10 pr-20">
                        Lorarn ipsum dolor sit amnet, consoctotur ad piscing oft.
                        Sod quis lacus non orci auismod
                    </p>
                </div>
                <div className="flex  flex-col sm:pt-32 sm:w-fit w-54">
                    <h3 className="font-black text-white sm:text-xl text-xs sm:pt-14 pt-5 w-full ">Company</h3>
                    <p className="text-white sm:text-xs  text-xxxs sm:pt-1 pt-1  pb-2  ">
                        Address: 123 Fifth Avenue, New York-1060, USA
                    </p>
                    <p className="text-white sm:text-xs text-xxxs   pb-2  ">
                ...
                <div className="flex  flex-col sm:pt-32 sm:w-fit w-2/6">
                    <h3 className="font-black text-white sm:text-xl text-xs sm:pt-14 pt-5 w-full ">Pages</h3>
                    <p className="text-white sm:text-xs  text-xxxs sm:pt-1 pt-1  pb-2  ">
                    &gt; Home
                    </p>
                    <p className="text-white sm:text-xs text-xxxs   pb-1  ">
                    &gt; Booking
                    </p>
                    <p className="text-white sm:text-xs  text-xxxs  pb-1  ">
                    &gt;  Facilities
                ...
                <div className="flex  flex-col sm:pt-32 w-fit">
                    <h3 className="font-black text-white sm:text-xl text-xs sm:pt-14 pt-5 w-full ">Contact Us</h3>
                    <div className="text-white sm:text-xs  text-xxxs sm:pt-3 pt-1  pb-2  flex">
